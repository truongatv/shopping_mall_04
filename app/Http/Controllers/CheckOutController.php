...
class CheckOutController extends Controller
{
    ...
    public function checkout_addresses(Request $request,$user_id,$order_id)
    {
        $this->validate($request, [
            ...
            'checkout-shipping-ostal.required' => trans('errors.postal_code'),
        ...
        try {
            $order->address = $request->input('checkout-shipping-address1').' | '.$request->input('checkout-shipping-postal');
